...
const Members = () => {
  return (
    <>
        <div className="w-full lg:pt-8 max-lg:pt-6 max-sm:pt-4 text-center flex flex-col justify-start items-center min-h-screen font-sora bg-blue-200 h-min">
      <span className="lg:text-4xl max-lg:text-2xl max-sm:text-xl font-bold pb-2">
        Heads of AI Council
      </span>
      <div className="w-[80%] flex flex-row flex-wrap flex-row items-center justify-evenly py-4 max-lg:hidden ">
  ...
  <MemberCard key={index} {...member} />
    ...
    <div className="w-full lg:pt-8 max-lg:pt-6 max-sm:pt-4 text-center flex flex-col justify-start items-center min-h-screen font-sora bg-red-200 h-min">
      <span className="lg:text-4xl max-lg:text-2xl max-sm:text-xl font-bold pb-2">
  ...
  <MemberCard key={index} {...submember} />
    ...
    <div className="w-full lg:pt-8 max-lg:pt-6 max-sm:pt-4 text-center flex flex-col justify-start items-center min-h-screen font-sora bg-green-200 h-min">
      <span className="lg:text-4xl max-lg:text-2xl max-sm:text-xl font-bold pb-2">
