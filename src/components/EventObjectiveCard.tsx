...
const EventObjectiveCard: React.FC<EventObjectiveCardProps> = ({ objective }) => {
  return (
    <div className="bg-white flex flex-col justify-start items-center lg:m-6 max-sm:m-4 text-center space-y-2 py-4 rounded-lg max-lg:min-w-[333px]">
      <span className="text-black w-[60%] font-semibold lg:text-2xl max-lg:text-lg max-sm:text-[14px]">
        {objective.title}
      </span>
...
export default EventObjectiveCard;
