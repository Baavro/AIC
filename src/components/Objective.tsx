...
const objectives = [
  ...
  },
  {
    ...
    description:
      'The council will collaborate with experts to develop innovative AI applications and use cases that benefit society and provide economic advantages to India.',
  },
  {
    id: 3,
    title: 'Support AI education',
    description:
      'The council will develop curricula for AI education programs in collaboration with leading institutions and organizations to develop AI workforce.',
  },
];
